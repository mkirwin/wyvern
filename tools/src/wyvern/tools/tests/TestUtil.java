...
public class TestUtil {
    ...
    //  public static final String WYVERN_TOOLS_PATH = WYVERN_HOME == null ? "tools" : WYVERN_HOME + "/tools";
    public static final String BASE_PATH = WYVERN_HOME == null ? "src/wyvern/tools/tests/" : WYVERN_HOME + "/tools/src/wyvern/tools/tests/";
